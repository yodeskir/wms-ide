(function (root, factory) {
  if(typeof define === "function" && define.amd) {
    ...
    ol.control.LayerSwitcher = function(opt_options) {
        ...
        var navtemplate = '<nav id="layer-panel" class="menu navigation-menu">'
            + '                <div class="col-md-12 navbar-header no-padding clearfix xs-text-left">'
            + '                    <h3><a class="no-padding section-link">Layer navigator</a></h3>'
            + '                </div>'
        ...
        element.className = "menu-wrap pull-menu";
        element.style.top = '10px';
        element.innerHTML = navtemplate;
        bodyEl.insertAdjacentElement('afterBegin', element);
        ...
        this.panel = $(element).find('#layer-navigator').get(0);
        //this.panel.className = 'menu navigation-menu';
    ...
    ol.control.LayerSwitcher.prototype.renderPanel = function() {
        ...
        ul.className = "nav navbar-default navbar-nav";
        ul.style.width = '100%';
